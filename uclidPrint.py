...
stateVars = {'rdx': '64','memory' : '1', 'rsp': '64','r11': '64', 'CR0' : '64', 'CS': '64', 'SS': '64', 'cs_selector': '16', 'cs_base': '32', 'cs_limit': '20', 'cs_accessRights': '12', 'cpl': '2', 'ss_selector': '16', 'ss_base': '32', 'ss_limit': '20', 'ss_accessRights': '12', 'EFER': '64', 'CR4': '64', 'rflags': '64', 'rcx': '64', 'rip': '64'}
...
"""
    ...
    def cleanRHS(self, var, rhs):
        ...
        elif var[3:] in cs_accessRightsDict or var[3:] in ss_accessRightsDict:
            var = var[3:]
            if var == "Type":
                numBits = "4"
            elif var == "DPL":
        ...
        for line in file:
            ...
            for word in line.split():
                ...
                if word == "if":
                    ...
                    self.inputs.add("r" + word[1].lower() + "x" )
                    ...
                    self.inputs.add("manyCacheTypes")
                else:
    ...
    def printInput(self):
        ...
        for key in self.inputs:
            if key == 'memory':
                ...
                print key + " : TRUTH;"
            elif key == "manyCacheTypes":
                print "State." + str(key) + " : FUNC[1] of cacheType;"
            else:
    ...
    def printDefine(self):
        ...
        for define in self.CS_SS:
            ...
            n = ""
            if define.split(" := ")[0].strip() in alreadyDef:
                n = "_n"
                change = define.split(" := ")[0].strip()
                for var in self.cvd:
                    self.cvd[var][0][0] = self.cvd[var][0][0].replace(change, change+n)
            print self.cleanLogic(define.split(" := ")[0].strip()) + n + " := " + rhs +";"
        ...
        for var in self.cvd:
            ...
            #otherwise there must at least one condition/rhs combo
                ...
                for rhsCondCombo in rhsCond:
                    ...
                    print "    " + self.cleanLogic(rhsCondCombo[1]) + " : " + rhs + ";"
